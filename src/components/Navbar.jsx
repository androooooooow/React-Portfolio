        ...
        <div className ="max-w-5xl mx-auto px-4">
            <div className ="flex justify-between items-center h-16">
                <a href ="#home " className ="font-mono text-xl font-bold text-white">
                    {""}
                    Drew<span className="text-blue-500">.Devs</span>{""}
                </a>

                <div className="w-7 h-5 relative cursor-pointer z-40 md:hidden " 
                onClick={() => setMenuOpen((preb) => !preb)}>
                    &#9776;
                </div>
                ...
                <div className="hidden md:flex items-center space-x-8">
                    ...
                    <a 
                        href="#project" className="text-gray-300 hover:text-white transition-colors"
                    ...
                    <a 
                        href="#contact" className="text-gray-300 hover:text-white transition-colors"
